          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-2xl">Users: Kentaur Capital Holdings Pty Ltd.</CardTitle>
                  <CardDescription className="mt-1">Owner: khennethcobyglegaspi@gmail.com</CardDescription>
                </div>
                ...
                <TabsContent value="approved" className="space-y-4">
                      ...
                      <tbody>
                        <tr className="border-t hover:bg-muted/30">
                          <td className="px-4 py-4">
                            <span className="font-medium">khennethcobyglegaspi@gmail.com</span>
                          </td>
                          <td className="px-4 py-4">
                  ...
                  <div className="pt-6 border-t">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      Kentaur Capital Holdings Pty Ltd., Employer ID: 2210a27448a1487c2db424dcc7786c84
                    </p>
                  </div>
                </TabsContent>
